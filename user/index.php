...
<div class="container">
			...
			<div class="row border top-navbar bg-dark text-light p-2">
				<h4>Automated Complaint Management Ticketing System</h4>
	...
	<div class="row border bg-light p-2">
		...
		<div class="col-sm-2" style="display: none;">
			<p class="side-tabs" id=""><i class="fas fa-lg fa-newspaper"></i><br>1 Not yet processed complaints</p>
		</div>
		<div class="col-sm-2">
			<p class="side-tabs" id=""><i class="fas fa-lg fa-newspaper"></i><br> 10 Complaints that are in process</p>
		</div>
		<div class="col-sm-2">
			<p class="side-tabs" id=""><i class="fas fa-lg fa-newspaper"></i><br> 3 Complaints that have been closed</p>
		</div>
	</div>
	</div>
	...
	<div class="row tabs-area bg-light shadow pl-0">
		<div class="col-sm-2">
			...
			<p class="side-tabs" id="lodge-complaint"><i class="fas fa-lg fa-pen"></i><br>Create Complaint</p>
