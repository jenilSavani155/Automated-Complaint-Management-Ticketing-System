...
$u = $complaint->executeQuery($user_query);
$query1 = "SELECT * FROM complaints WHERE cloud_eng_id =$uid AND status is null";
$query2 = "SELECT * FROM complaints WHERE cloud_eng_id =$uid AND status = 'in process'";
$query3 = "SELECT * FROM complaints WHERE cloud_eng_id =$uid AND status = 'closed'";
 ...
 <?php include('include/header.php'); ?>
  <div id="wrapper">
   <!-- Sidebar -->
       ...
       <ul class="sidebar navbar-nav mr-4" style="background: #002a53 !important">
